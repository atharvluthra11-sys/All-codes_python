...
st.set_page_config(page_title="Pokedex App", page_icon=":pencil:", layout="wide")
...
st.set_page_config(page_title="Pokedex App", page_icon=":pencil:", layout="wide")
st.write("Hello", username + ", welcome to the Pokedex App!")
if response.status_code == 200:
    prased_content = bs(response.content, "html.parser")
    table = prased_content.find("table", id="pokedex")
